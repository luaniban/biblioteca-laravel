                    ...
                    <div class="flex items-center w-full gap-8 ">
                        ...
                        <div class="flex flex-col w-full gap-12 mt-8">
                            ...
                            @endphp
                                ...
                                <div class="mb-4 text-2xl font-semibold">{{$escola->name }}</div>

                                    <div class="flex px-4 pt-12 pb-8 shadow-xl w-[70vw]  shadow-slate-700 relative bg-[url('./img/prateleira.png')] bg-cover bg-center bg-no-repeat">
                                        ...
                                        <div class="w-full swiper swiper_{{ $escola->id }}">
                                            <div class="swiper-wrapper">
                                                @foreach ( $livrosAll as $livro )
                                                        ...
                                                        <div id="card" class="flex flex-col items-center justify-center w-40 shadow-xl swiper-slide h-60 bg-gradient-to-t from-gray-300 to-gray-50 shadow-slate-900">
